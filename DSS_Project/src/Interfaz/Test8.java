 ...
 * @author andre
 */
public class Test8 extends javax.swing.JPanel {
    ...
    public Test8() {
        initComponents();
        if(Principal.test.getQuestion_8().equals("yes")) {
               this.buttonYes.setSelected(true);
        }
        else if(Principal.test.getQuestion_8().equals("no")) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Do you suffer from espasmodic episodes in arms and legs? ");
    ...
    private void buttonYesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonYesActionPerformed
        ...
        if(buttonYes.isSelected()) {
            Principal.test.setQuestion_8("yes");
        }
    ...
    private void buttonNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonNoActionPerformed
        ...
        if(buttonNo.isSelected()) {
            Principal.test.setQuestion_8("no");
            Principal.test.setQuestion_9("not considered");
        }

 ...
 * @author andre
 */
public class Test10 extends javax.swing.JPanel {
    ...
    public Test10() {
        initComponents();
        if(Principal.test.getQuestion_10().equals("yes")) {
               this.buttonYes.setSelected(true);
        }
        else if(Principal.test.getQuestion_10().equals("no")) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Did you suffer urination episodes while you sleep? ");
    ...
    private void buttonYesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonYesActionPerformed
        ...
        if(buttonYes.isSelected()) {
            Principal.test.setQuestion_10("yes");
        }
    ...
    private void buttonNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonNoActionPerformed
        ...
        if(buttonNo.isSelected()) {
            Principal.test.setQuestion_10("no");
        }

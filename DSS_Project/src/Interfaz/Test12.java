 ...
 * @author andre
 */
public class Test12 extends javax.swing.JPanel {
    ...
    public Test12() {
        initComponents();
        if(Principal.test.getQuestion_12().equals("yes")) {
            this.buttonYes.setSelected(true);
        }
        else if(Principal.test.getQuestion_12().equals("no")) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Someone in your family suffers from epilepsy?");
